...
/// Hosts the SwiftUI view for `RecentsRIB` and bridges UIKit view lifecycle events.
final class ___VARIABLE_productName___ViewController: UIViewController {
    ...
    /// Constructs an instance of ``___VARIABLE_productName___SwiftUIView``, wraps it inside a `UIHostingController`,
    /// and sets it as the first child of this view controller.
